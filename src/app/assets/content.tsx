  ...
  return (
    <>
      ...
      <section className="w-screen h-screen flex-shrink-0 grid grid-cols-1 lg:grid-cols-2">
        <div className="bg-black text-white flex flex-col justify-center px-8 lg:px-16 lg:border-0">
      ...
      {/* SLIDE 3: Our Investments */}
      {/*
        This section has a lot of content.
        We'll add `overflow-y-auto` so it scrolls internally if it exceeds the screen height.
      */}
